...
def test_parse_pdf_page_range(tmp_path: Path):
    """Проверка извлечения только заданного диапазона страниц PDF."""
...
def test_parse_and_save_pdf_with_sources_yaml_page_range(tmp_path: Path):
    """Проверка автоматического применения page_range из sources.yaml."""
...
def test_sources_yaml_contains_page_ranges():
    """Проверка наличия корректных page_range в основном sources.yaml."""
