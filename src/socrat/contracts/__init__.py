...
Правила:
  ...
  * Менять контракт может только Claude (архитектор) через PR с меткой `contract`.
    Нужны изменения — опишите их в docs/contract_change_requests.md и отметьте в PR.
